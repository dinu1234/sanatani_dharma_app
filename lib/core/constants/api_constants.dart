class ApiConstants {
  ...
  static const String listSpiritualMedia =
      "user/spiritual_media/list_media.php";
  static const String getSpiritualMediaDetail =
      "user/spiritual_media/get_media_detail.php";
